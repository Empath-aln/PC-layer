...
# Launch training for the Muon_pc_271M configuration.
#
...
#   LOG_RANK=0,1 NGPU=4 bash scripts/train/Muon_pc_271M.sh
NGPU=${NGPU:-"8"}
NNODES=${NNODES:-"1"}
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/Muon_pc_271M.toml"}
