...
# Launch training for the AdamW_baseline_271M configuration.
#
...
#   LOG_RANK=0,1 NGPU=4 bash scripts/train/AdamW_baseline_271M.sh
NGPU=${NGPU:-"8"}
NNODES=${NNODES:-"1"}
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/AdamW_baseline_271M.toml"}
