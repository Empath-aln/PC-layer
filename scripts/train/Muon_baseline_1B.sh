...
# Launch training for the Muon_baseline_1B configuration.
#
...
#   LOG_RANK=0,1 NGPU=4 bash scripts/train/Muon_baseline_1B.sh
NGPU=${NGPU:-"8"}
NNODES=${NNODES:-"1"}
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/Muon_baseline_1B.toml"}
